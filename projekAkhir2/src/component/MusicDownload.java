...
public class MusicDownload extends javax.swing.JPanel {
    ...
    public void init() {
        ...
        //rencananya buat variabel yang bakal nyimpen judul lagu, artist, dll (menyesuaikan sama model).Nanti variabel itu bakal jadi parameter atau nggak langsung ke database bisa.
         ...
         listMusicDownload1.addItem(new Model_Music("1", "Mary on a", "03:00", "D:\\lagu1.mp3"));
         listMusicDownload1.addItem(new Model_Music("1", "cupid", "03:00", "D:\\lagu2.mp3"));
    ...
    public void init(String no, String title, String time, String Directory) {
        listMusicDownload1.addItem(new Model_Music(no, title, time, Directory));
        listMusicDownload1.addItem(new Model_Music(no, title, time, Directory));
    }
