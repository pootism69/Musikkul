...
public class ItemMusicDownload extends javax.swing.JPanel {
    ...
    public void setPlay(boolean play, Model_User user1, int Index1, Object playingMusic) {
        ...
        if (play) {
            ...
            this.user = user1;
            if(Index1 > before ){
                playSelectedSongForward(playingMusic, Index1);
                user.play();
                
            }else if(Index1 < before){
                playSelectedSongBackward(playingMusic, Index1);
                user.play();
            }else{
    ...
    // Metode untuk mengganti status pemutaran (play/stop) saat panel di klik
    ...
    private void playSelectedSongForward(Object song, int index) {
    ...
    private void playSelectedSongBackward(Object song, int index) {
        // Dapatkan indeks lagu yang akan diputar
